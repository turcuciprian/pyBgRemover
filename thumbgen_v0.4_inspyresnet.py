...
def process(args: argparse.Namespace) -> None:
    color_str = args.outline_color.lstrip("#")
    color = ImageColor.getrgb(f"#{color_str}" if len(color_str) in (3,6) else args.otline_color)
...
if __name__ == "__main__":
    ...
    for flags, kwargs in (
        ...
        (("--outline-color",), {"default": "#ffffff", "help": "Hex white color. the string here should be a hex value with the # before it"}),
